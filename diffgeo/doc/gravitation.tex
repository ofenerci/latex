...
In this book, we use \lingo{geometric objects} to model object properties and to measure such properties and we use \lingo{geometric transformations} to represent physical processes.
