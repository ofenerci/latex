...
Consider air as an \lingo{inviscid fluid}. An inviscid fluid is a fluid with no viscosity, resulting thus in no drag. Inviscid air implies no viscosity, thus no drag. Hence, $\kdim_9 = 0$.
