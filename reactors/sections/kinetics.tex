...
\lingo{Reaction kinetics} is the branch of chemistry that quantifies rates of reaction. Even though this branch treats all types of chemical reactions, herein, however, we limit the treatment to \lingo{elementary chemical reactions}. An elementary reaction is a chemical reaction whose rate corresponds to a stoichiometric equation.
...
\eeq
Then, define the \lingo{reaction rate}, $\rrate$, by
\beq
