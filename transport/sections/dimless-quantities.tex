...
%
\item thermal energy transport: $\flux\then = -\kthcond/\dens\kshcap\times$, where thermal energy flux $\dim\flux\then = \phdim E/\phdim L^2\phdim T$, thermal conductivity $\dim\kthcond = \phdim E/\phdim L\phdim T\phdimtemp$, mass density $\dim\dens = \phdim E\phdim T^2/\phdim L^5$, specific thermal capacity $\dim\kshcap = \phdim L^2/\phdim T^2\phdimtemp$ and energy density gradient $\dim\grad\thendens = \phdim E/\phdim L^4$.
%
